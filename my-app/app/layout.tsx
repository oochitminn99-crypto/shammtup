...
export const metadata: Metadata = {
  ...
  description: "မကွေးတိုင်း ၊ သရက်ခရိုင် ၊ အထက်မင်းလှမြို့နယ် ၊ ရှမ်းတပ်ကြီးကျေးရွာမှ လုံးဇကာတပ်ဆင်ထားတဲ့ဆန်စက် | shammtup village upper minnhla township magway division. | latest nextjs website | modern nextjs weebsite",
